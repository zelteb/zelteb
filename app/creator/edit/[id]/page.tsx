...
export default function EditProduct() {
  ...
  const save = async () => {
    ...
    if (file) {
      ...
      if (fileError) { alert(fileError.message); setLoading(false); return; }
  ...
  const previewThumb = thumbPreview || existingThumb;

  if (fetching) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "DM Sans, sans-serif", color: "#a1a1aa" }}>
        <div style={{ textAlign: "center" }}>
          <div style={{ width: 36, height: 36, border: "3px solid #e4e4e7", borderTopColor: "#7c3aed", borderRadius: "50%", animation: "spin 0.7s linear infinite", margin: "0 auto 12px" }} />
          Loading product...
        </div>
      </div>
    );
        ...
        <div className="up-wrap">
          <div className="up-inner">
            ...
            <div className="up-card">
              ...
              <div className="up-card-body">
                <p className="up-hint" style={{ marginBottom: 14 }}>Upload a new thumbnail to replace the existing one.</p>
            ...
            <div className="up-submit-row">
              ...
              <button className="up-btn" onClick={save} disabled={loading}>
