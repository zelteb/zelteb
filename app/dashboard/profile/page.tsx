...
export default function BrandProfile() {
  ...
  const save = async () => {
    ...
    if (mobile && !/^\+?[0-9]{7,15}$/.test(mobile.replace(/\s/g, ""))) {
      setMobileError("Enter a valid mobile number"); return;
    }
    setBrandNameError("");
    setMobileError("");
    setSaving(true);
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 space-y-5">
            ...
            <div>
              ...
              <input
                ...
                inputMode="tel"
                className={`${inputClass} ${mobileError ? "border-red-400 focus:ring-red-200" : ""}`}
              />
