    ...
    <>
      <style>{`
        @media (max-width: 768px) {
          ...
          .help-grid { flex-direction: column !important; }
      ...
      <div className="help-wrap max-w-4xl mx-auto py-10 px-6">
        ...
        {/* Side by side grid */}
        <div className="help-grid flex gap-6 items-start">

          {/* Left — Contact Form */}
          <div className="help-card bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex-1">
